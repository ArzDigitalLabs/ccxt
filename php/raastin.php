...
class raastin extends Exchange {
    ...
    public function fetch_markets($params = array ()): array {
        ...
        if ($marketType === 'otc') {
            ...
            for ($i = 0; $i < count($qoutes); $i++) {
                $quote = $qoutes[$i];
                $OTCmarkets = $this->publicGetApiV1Market ($this->extend($query, array( 'quote' => $quote )));
        ...
        $response = $this->publicGetApiV1MarketSymbols ($query);
    ...
    public function fetch_tickers(?array $symbols = null, $params = array ()): array {
        ...
        if ($marketType === 'otc') {
            ...
            for ($i = 0; $i < count($qoutes); $i++) {
                ...
                for ($j = 0; $j < count($OTCmarkets); $j++) {
                    ...
                    $ticker = $this->parse_otc_ticker($OTCmarkets[$j]);
        ...
        for ($i = 0; $i < count($tickerSymbols); $i++) {
            ...
            $marketData = $this->publicGetApiV1MarketSymbolsSymbol ($this->extend($request, $query));
    ...
    public function fetch_ticker(string $symbol, $params = array ()): array {
        ...
        $this->load_markets(false, array( 'type' => $marketType ));
        if ($marketType === 'otc') {
            $tickers = $this->fetch_tickers(array( $symbol ), array( 'type' => 'otc' ));
        ...
        $query = $this->omit($params, 'type');
        $response = $this->publicGetApiV1MarketSymbolsSymbol ($this->extend($request, $query));
