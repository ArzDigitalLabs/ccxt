...
class bit24 extends Exchange {
    ...
    public function fetch_markets($params = array ()): array {
         ...
         */
        $result = array();
        $OTCresponse = $this->publicGetApiV1CoinsSimpleList ();
        ...
        while (true) {
            $response = $this->publicGetProCapiV1Markets ($this->extend($params, array(
                'page' => $page,
                'per_page' => $limit,
            )));
    ...
    public function fetch_tickers(?array $symbols = null, $params = array ()): array {
        ...
        $result = array();
        $Otcresponse = $this->publicGetApiV1CoinsSimpleList ($params);
    ...
    public function remove_duplicate_values(array $markets): array {
        $uniqueMarkets = array();
        $seenIds = array();
