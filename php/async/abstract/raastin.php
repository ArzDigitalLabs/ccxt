...
abstract class raastin extends \ccxt\async\Exchange {
    ...
    public function public_get_api_v1_market_symbols_symbol($params = array()) {
        return $this->request('api/v1/market/symbols/{symbol}/', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function publicGetApiV1MarketSymbolsSymbol($params = array()) {
        return $this->request('api/v1/market/symbols/{symbol}/', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
