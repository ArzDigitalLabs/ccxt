...
use ccxt\async\abstract\tehran_exchange as Exchange;
use \React\Async;
...
class tehran_exchange extends Exchange {
    ...
    public function fetch_markets($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
             ...
             */
            $response = Async\await($this->publicGetOtcV1MarketPair ($params));
    ...
    public function fetch_tickers(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            ...
            for ($i = 0; $i < count($filteredPairs); $i++) {
                ...
                $priceResponse = Async\await($this->publicGetOtcV1MarketOrderPairPrice ($request));
