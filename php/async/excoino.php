...
class excoino extends Exchange {
    ...
    public function fetch_ohlcv(string $symbol, $timeframe = '1h', ?int $since = null, ?int $limit = 200, $params = array ()): PromiseInterface {
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $response = Async\await($this->publicGetMarketExchangePlateFull ($request));
            $orderBook = array();
