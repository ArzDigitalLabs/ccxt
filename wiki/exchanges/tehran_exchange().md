...
<a name="tehran_exchange" id="tehran_exchange"></a>

## tehran_exchange{docsify-ignore}
**Kind**: global class  
...
**Kind**: instance method of [<code>tehran\_exchange</code>](#tehran_exchange)  
...
```javascript
tehran_exchange.fetchMarkets ([params])
```
...
```javascript
tehran_exchange.fetchTickers (symbols[, params])
```
...
```javascript
tehran_exchange.fetchTicker (symbol[, params])
```
