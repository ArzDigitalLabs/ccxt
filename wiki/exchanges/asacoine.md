...
<a name="asacoine" id="asacoine"></a>

## asacoine{docsify-ignore}
**Kind**: global class  
...
**Kind**: instance method of [<code>asacoine</code>](#asacoine)  
...
```javascript
asacoine.fetchTickers (symbols[, params])
```
...
```javascript
asacoine.fetchTicker (symbol[, params])
```
