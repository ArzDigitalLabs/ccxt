...
class kcex(Exchange, ImplicitAPI):
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        futuresResponse = await self.futuresGetContractTicker(params)
    ...
    async def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        if params['type'] == 'future':
            response = await self.futuresGetContractTicker(params)
    ...
    async def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        response = {}
        if params['type'] == 'future':
            response = await self.futuresGetContractTicker(request)
