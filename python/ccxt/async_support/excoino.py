...
class excoino(Exchange, ImplicitAPI):
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        """
        response = await self.publicGetMarketSymbolThumbTrend()
        result = []
    ...
    async def fetch_ohlcv(self, symbol: str, timeframe='1h', since: Int = None, limit: Int = 200, params={}) -> List[list]:
        """
        ...
        response = await self.publicGetMarketHistory(request)
        for i in range(0, len(response)):
            if market['quote'] == 'IRT':
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        response = await self.publicGetMarketExchangePlateFull(request)
        orderBook = {}
