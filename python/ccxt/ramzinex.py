...
class ramzinex(Exchange, ImplicitAPI):
    ...
    def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        response = self.publicGetExchangeApiV10ExchangePairs(request)
    ...
    def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}) -> List[list]:
        ...
        response = self.publicGetExchangeApiV10ExchangeChartTvHistory(request)
    ...
    def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        response = self.publicGetExchangeApiV10ExchangeOrderbooks(request)
