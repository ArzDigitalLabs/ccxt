...
class bit24(Exchange, ImplicitAPI):
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        """
        result = []
        OTCresponse = self.publicGetApiV1CoinsSimpleList()
    ...
    def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        result = {}
        Otcresponse = self.publicGetApiV1CoinsSimpleList(params)
    ...
    def remove_duplicate_values(self, markets: List[Market]) -> List[Market]:
        uniqueMarkets = []
        seenIds = Set()
